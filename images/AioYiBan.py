        ...
        try:
            ...
            <div style="background:linear-gradient(to right,#cccc,white);; width: 95%; max-width: 800px; margin: auto auto; border-radius: 5px; border:skyblue 2px solid; overflow: hidden; -webkit-box-shadow: 0px 0px 20px 0px rgba(0, 0, 0, 0.12); box-shadow: 0px 0px 20px 0px rgba(0, 0, 0, 0.18); font-family : YouYuan;">
                ...
                <div style="width: 100%;height: 100%;box-shadow: 5px 5px 3px rgba(131, 89, 89, 0.3);text-align: center;">
                        <img style="width:100%;z-index: 666;height: 100%;box-shadow: 1px;" src="https://cdn.jsdelivr.net/gh/subcarry/AioYiBan@main/images/aml.png">
                </div>
                ...
                <img src="https://cdn.jsdelivr.net/gh/subcarry/AioYiBan@main/images/rll.gif" alt="" style="width:20px;position: absolute;top: 0;right: 20px;">
                ...
                <p style="position: relative;color: white;background:#7c7676;padding: 5px 10px;margin: 15px auto 0 ;">泰拉瑞亚是冒险之地！是神秘之地！是可让你塑造、捍卫、享受的大地。在泰拉瑞亚，你有无穷选择。手指发痒的动作游戏迷？建筑大师？收藏家？探险家？每个人都能找到自己想要的。</p>
                    <div style="float:left; width:50%;margin-top: 18.5px;">
                       <img src="https://cdn.jsdelivr.net/gh/subcarry/AioYiBan@main/images/skd.png" alt="" style="border-radius: 30px;width: 100%;">
                        <div></div>
                      ...
                      <div style="width: 45%;float: right;margin-top: 18.5px;">
                        ...
                        <div style="margin-top: 12px;">
                               <img src="https://cdn.jsdelivr.net/gh/subcarry/AioYiBan@main/images/a1.jpg" alt="" style="width: 45%; max-width: 100px;border-top-left-radius: 40px;">
                               <img src="https://cdn.jsdelivr.net/gh/subcarry/AioYiBan@main/images/a2.jpg" alt="" style="width:45%; max-width: 100px;border-top-right-radius: 40px;"><br>
                               <img src="https://cdn.jsdelivr.net/gh/subcarry/AioYiBan@main/images/a3.jpg" alt="" style="width:45%; max-width: 100px;border-bottom-left-radius: 40px;">
                               <img src="https://cdn.jsdelivr.net/gh/subcarry/AioYiBan@main/images/a4.jpg" alt="" style="width: 45%; max-width: 100px;border-bottom-right-radius: 40px;">
                        </div>
                      </div>
                    </div>    
               <div style="clear:both;margin-bottom: 10px;"></div>
               <div class="footer" style="text-align: center;"><img src="https://cdn.jsdelivr.net/gh/subcarry/AioYiBan@main/images/233.jpg" alt="" style="width: 90%;"></div>
                <p style="font-size: 12px;text-align: center;color: #999;">本邮件由可露希尔酱发出。<br>
                Copyright &copy; 2021 <a style="text-decoration:none; color: #66ccff;" target="_blank" href="https://github.com/subcarry/AioYiBan">subcarry</a> Rhode Island</p>
                </div>
                </div>
                    """
